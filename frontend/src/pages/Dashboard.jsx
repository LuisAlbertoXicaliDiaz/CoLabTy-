    ...
    <div className="flex h-screen bg-slate-50 font-sans">
      ...
      <aside className="hidden md:flex flex-col w-64 bg-indigo-950 text-white shadow-xl">
        ...
        <nav className="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
          ...
          {/* Items Inactivos */}
          <a href="#" className="flex items-center gap-3 px-3 py-2.5 text-indigo-200 hover:bg-indigo-900/50 hover:text-white rounded-lg font-medium transition-colors">
        ...
        <div className="p-4 border-t border-indigo-900/50">
          <div className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-indigo-900/50 cursor-pointer transition-colors">
            <div className="w-9 h-9 rounded-full bg-violet-500 flex items-center justify-center text-white font-bold">
              LD {/* Iniciales placeholder */}
            </div>
            <div className="flex-1 min-w-0">
              <p className="text-sm font-semibold text-white truncate">Luis Díaz</p>
              <p className="text-xs text-indigo-300 truncate">Workspace Principal</p>
            </div>
          </div>
        </div>
      </aside>
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-6 lg:p-8">
          ...
          <div className="mb-8">
            <h2 className="text-2xl font-bold text-slate-900">Hola de nuevo, Luis 👋</h2>
